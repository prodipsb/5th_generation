...
$one_category = $categoryobj->select_one_categories($_GET['category_id']);
$categories_info = $categoryobj->select_all_categories();
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" id="title"
                                                       value="<?php echo $one_category['title'] ?>" placeholder="Enter A Title">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="parent_id" class="form-control">
                                                    ...
                                                    foreach ($categories_info as $v_category) {
                                                        ?>
                                                        <option
                                                            value="<?php echo $v_category['id']; ?>"<?php if ($v_category['id'] = $one_category['parent_id']){ echo "selected";} ?>><?php echo $v_category['title']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <textarea name="category_des" class="ckeditor" id="myeditor" rows="4"
                                                         cols="50" required><?php echo $one_category['category_des'] ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="radio" name="publication_status" value="1"<?php if ($one_category['publication_status'] = 1){ echo "checked";} ?>>
                                                    Published<br/>
                                                    <input type="radio" name="publication_status" value="0"<?php if ($one_category['publication_status'] = 0){ echo "checked";} ?>> Unpublished
                                                </div>
                                            </div>
                                        </div>
