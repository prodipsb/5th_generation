...
$user_profile_info_by_user_id = $profileobj->view_user_details($user_id);

 $count_posted_articles = $articleobj->count_all_articles_by_user_id($user_id);
//echo '<pre>';
//print_r($count_posted_articles);
//exit();
?>
<?php include_once 'admin_header.php';?>
                ...
                <div class="col-md-10" id="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <span style="text-align: center; margin-left: 550px; color: green; font-size: 18px">
                                        <?php
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-4">
                                    <div class="main-box clearfix">
                                        ...
                                        <div class="profile-message-btn center-block text-center">
                                            <a href="../contact_us.php" target="blank" class="btn btn-success">
