                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="parent_id" class="form-control">
                                                    ...
                                                    foreach ($menus as $v_menu) {
                                                        ?>
                                                        <option
                                                            value="<?php echo $v_menu['id']; ?>"><?php echo $v_menu['title']; ?></option>
                                                    <?php } ?>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="radio" name="url"
                                                           value="<?php echo "category_archive.php?category_id=".$category['id']; ?>"><?php echo $category['title']; ?><br>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php foreach ($page_all as $page){ ?>
                                                        <input type="radio" name="url"
                                                               value="<?php echo "page.php?id=".$page['id']; ?>"><?php echo $page['title']; ?><br>
